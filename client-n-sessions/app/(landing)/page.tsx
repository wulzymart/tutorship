...
const HomePage = () => {
  ...
  <div className="flex-1">
    <Link href="/" className=""><div className=" flex w-full justify-center rounded-lg">
        <Image
  ...
  <div className="flex-none">
    <ul className="menu menu-horizontal px-1">
      <li> <Link className="hover:text-gray-300 mb-2 lg:mb-0" href="#features">
            Features
          </Link>
         </li>
         <li> <Link href="#about" className="hover:text-gray-300">About
          </Link></li>
    </ul>
  </div>
</div>
        <div className="bg-[url('https://images.freeimages.com/images/large-previews/2a0/open-book-1417491.jpg')] bg-cover relative w-full h-[600px] lg:h-80 xl:h-96 mb-4 flex justify-center items-center">
          ...
          <div className='relative z-10'><h1 className="text-3xl lg:text-4xl xl:text-5xl font-bold mb-4">Tutorship</h1>
        <p className="text-lg lg:text-xl xl:text-2xl mb-4">Enriching minds, developing skills: Tutorship, Learn today, Stand tomorrow</p>
        <Link href="/tutor/register" className="bg-white text-main2 text-lg font-medium px-4 py-2 rounded-md mt-4 inline-block">Get Started
        </Link></div>
      ...
      <section id="features" className="text-center mb-8 mt-10">
        <h2 className="text-xl lg:text-2xl xl:text-3xl font-bold mb-10">Key Features</h2>
        {/* Feature 1 */}
      ...
      <section id="about" className="text-center w-[80%] mx-auto mb-20">
        <h2 className="text-xl lg:text-2xl xl:text-3xl font-bold mb-10">About Us</h2>
        <p className="mb-4">
        Knowing there are so many websites offering learning services with good learning management system, We discovered that only few or no webssites actually create an effective means of interaction between tutors and learers.
        </p>
        <p className="mb-4">Tutorship promotes true mntorship, in which tutors can sell curses, and learners can buy, with the opportunity to subscribe to a tutor for mentorship and the tutor will have a live sesssions with full partcipant of the learners.</p>
        <p>This is a Portfolio Project for <a className = "text-blue-50" href='https://www.alxafrica.com/'>Holberton School (ALX Africa)</a>. Project implementation started November 2023 and still in progresss</p>
        ...
        <div className="flex flex-col lg:flex-row lg:justify-center space-y-4 lg:space-y-0 lg:gap-x-10 md:gap-x-10my-8">
          ...
          <div>
            ...
            <div className="flex space-x-4">
              <a href="https://www.linkedin.com/in/adetunji-adekunle-835755233/" target="_blank" rel="noopener noreferrer">
                LinkedIn
              </a>
              <a href="https://github.com/AdekunleAdetunji" target="_blank" rel="noopener noreferrer">
                GitHub
              </a>
          ...
          <div>
            ...
            <div className="flex space-x-4">
              <a href="https://www.linkedin.com/in/olawale-olawole-2a5990270/" target="_blank" rel="noopener noreferrer">
                LinkedIn
              </a>
              <a href="https://github.com/wulzymart" target="_blank" rel="noopener noreferrer">
                GitHub
              </a>
              <a href="https://twitter.com/wulzymart" target="_blank" rel="noopener noreferrer">
                Twitter
              </a>
            </div>
          </div>
        ...
        <p className="mt-4">
          <a href="https://github.com/wulzymart/tutorship" target="_blank" rel="noopener noreferrer" className="text-blue-500 underline">
            GitHub Repository
          </a>
        </p>
      </section>
